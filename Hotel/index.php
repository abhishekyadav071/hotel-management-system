...
<div class="about-wthree" id="about">
    <div class="container">
        <div class="ab-w3l-spa">
            <h3 class="title-w3-agileits title-black-wthree">About Our Royal Inn Kanpur</h3> 
            
            <p class="about-para-w3ls">
                Welcome to Royal Inn Kanpur, where comfort meets luxury. 
                Our hotel offers spacious rooms, modern amenities, delicious Indian cuisine, 
                and warm hospitality to make your stay memorable. 
                Whether you are here for business or family vacation, 
                we ensure a relaxing and pleasant experience.
            </p>
            
            <img src="images/about.jpg" class="img-responsive" alt="Royal Inn Hotel">
            
            <div class="w3l-slider-img">
                <img src="images/a1.jpg" class="img-responsive" alt="Hotel Room">
            </div>
            
            <div class="w3ls-info-about">
                <h4>Experience Indian Hospitality at its Best!</h4>
                <p>
                    Enjoy comfortable rooms, free Wi-Fi, delicious food, 
                    and 24x7 customer support with us.
                </p>
            </div>
        </div>
        <div class="clearfix"></div>
            ...
            <div class="advantage-bottom">
                ...
                <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
                    <div class="advantage-block">
                        ...
                        <p>
                            We provide hassle-free room booking with online and offline payment options 
                            for your convenience.
                        </p>
                        <p><i class="fa fa-check" aria-hidden="true"></i>Fully furnished AC rooms</p>
                        <p><i class="fa fa-check" aria-hidden="true"></i>Attached washroom and balcony</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
                    <div class="advantage-block">
                        ...
                        <p>
                            Enjoy delicious Indian and continental food anytime with our 24x7 
                            restaurant and room service.
                        </p>
                        <p><i class="fa fa-check" aria-hidden="true"></i>24 hours room service</p>
                        <p><i class="fa fa-check" aria-hidden="true"></i>24-hour customer support</p>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div id="horizontalTab">
            ...
            <ul class="resp-tabs-list">
                <li><img src="images/teams1.jpg" alt="" class="img-responsive" /></li>
                <li><img src="images/teams2.jpg" alt="" class="img-responsive" /></li>
                <li><img src="images/teams3.jpg" alt="" class="img-responsive" /></li>
                <li><img src="images/teams4.jpg" alt="" class="img-responsive" /></li>
            </ul>
            ...
            <div class="resp-tabs-container">
                ...
                <div class="tab1">
                    ...
                    <div class="col-md-6 team-Info-agileits">
                        ...
                        <p>
                            Rahul Sharma manages all hotel operations and ensures that every guest
                            receives excellent service and a comfortable stay experience.
                        </p>
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="tab2">
                    ...
                    <div class="col-md-6 team-Info-agileits">
                        ...
                        <p>
                            Priya welcomes guests with warmth and helps with check-in, room booking,
                ...
                <div class="tab3">
                    ...
                    <div class="col-md-6 team-Info-agileits">
                        ...
                        <p>
                            Amit looks after daily hotel services, housekeeping, and guest satisfaction
                            to maintain premium hospitality standards.
                        </p>
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="tab4">
                    ...
                    <div class="col-md-6 team-Info-agileits">
                        <h4>Neha Yadav</h4>
                        <span>Guest Service Executive</span>
                        <p>
                            Neha assists guests with restaurant bookings, room service, and travel-related
                ...
                <ul class="slides">
                    ...
                    <li>
                        ...
                        <div class="w3layouts_work_grid_right">
                            ...
                            <p>
                                The rooms were clean, staff was polite, and the food was amazing.
                    ...
                    <li>
                        ...
                        <div class="w3layouts_work_grid_right">
                            ...
                            <p>
                                Very comfortable rooms and quick room service.
                    ...
                    <li>
                        ...
                        <div class="w3layouts_work_grid_right">
                            ...
                            <p>
                                Best hotel in budget with all facilities like WiFi,
                    ...
                    <li>
                        ...
                        <div class="w3layouts_work_grid_right">
                            ...
                            <p>
                                Good staff behavior and hygienic rooms.
    ...
    <div class="container">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile2">
            <div class="contact-agileits">
                <h4>Contact Us</h4>
                <p class="contact-agile2">Get in touch with us for booking and enquiries</p>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1">
            ...
            <p class="contact-agile1"><strong>Phone :</strong> +91 98765 43210</p>
            <p class="contact-agile1"><strong>Email :</strong> 
                <a href="mailto:info@royalinnkanpur.com">info@royalinnkanpur.com</a>
            </p>
            <p class="contact-agile1"><strong>Address :</strong> Civil Lines, Kanpur, Uttar Pradesh, India</p>
...
<!-- footer -->
<div class="copy text-center" style="padding:15px 0; background:#111; color:#fff; margin-top:20px;">
    <p>
        © 2026 Royal Inn Kanpur. All Rights Reserved | 
        Designed & Developed by <strong>Abhishek Yadav</strong>
    </p>
</div>
<!-- /footer -->
			<div class="copy">
